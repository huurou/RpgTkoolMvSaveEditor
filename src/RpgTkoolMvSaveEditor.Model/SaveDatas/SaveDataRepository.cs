...
public class SaveDataRepository(Context context, ISystemLoader systemLoader, IItemsLoader itemsLoader, IWeaponsLoader weaponsLoader, IArmorsLoader armorsLoader) : ISaveDataRepository
{
